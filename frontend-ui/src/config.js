...
export const API_GATEWAY_ENDPOINT = isProduction
  ? 'https://ffoatbqxz5.execute-api.us-east-1.amazonaws.com/prod'  // Replace with your actual API Gateway endpoint
  : 'http://localhost:3000';  // Local development

// CloudFront URL for production
export const CLOUDFRONT_URL = 'https://djtc2gb28iaxg.cloudfront.net';  // Replace with your actual CloudFront URL
